...
<head>
    ...
    <title><?php echo htmlspecialchars($titulo); ?> - Elegancia Store</title>
...
<body>
    ...
    <section class="propaganda">
        ...
        <div class="conteudo-propaganda">
            ...
            <a class="botao-colecao" href="<?= BASE_URL ?>/home?categoria=novidades">Explorar Coleção</a>
        </div>
    </section>
    ...
    <div id="tamanho-modal" class="tamanho-modal">
        ...
        <div id="tamanho-modal-opcoes" class="tamanho-opcoes"></div>
